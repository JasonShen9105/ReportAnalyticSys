...
public class QuartzController extends BaseController {
    ...
    public String addJob(Model model, String jobName) throws ParseException, SchedulerException {
		if (isPost()) {
			...
			boolean rlt = quartzService.addGetFileJob(jobName);
...
//     */
//    @Permission("1001")
//    @RequestMapping("/addFileJob")
//    public String addFileJob(Model model, String jobName) throws ParseException, SchedulerException {
//		if (isPost()) {
//			model.addAttribute("jobName", jobName);
//			model.addAttribute("loginName", getSSOToken().getData());
//			//boolean rlt = quartzService.addDemoJob(jobName);
